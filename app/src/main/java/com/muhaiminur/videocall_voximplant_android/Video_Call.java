...
public class Video_Call extends AppCompatActivity {
    ...
    private static final String TAG = "Normal Video Call";
    private static final String USERNAME = "abir1@itclan.muhaiminuritclanbd.voximplant.com";
    //private static final String USERNAME = "abir2@itclan.muhaiminuritclanbd.voximplant.com";
    private static final String PASSWORD = "12301019";
    ...
    private void call() {
        if (missingPermissions().size() == 0) {
            ...
            ICall call = mClient.call("abir2@itclan.muhaiminuritclanbd.voximplant.com",callSettings);
            if (call != null) {
    ...
    private List<String> missingPermissions() {
        ...
        return Voximplant.getMissingPermissions(getApplicationContext(), true);
    }
